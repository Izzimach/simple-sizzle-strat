...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t3765) {
      cljs.core.t3765 = {};
      cljs.core.t3765 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta3766 = c;
      ...
      cljs.core.t3765.cljs$lang$type = !0;
      cljs.core.t3765.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t3765")
      };
      cljs.core.t3765.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t3765")
      };
      var c = cljs.core.t3765.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t3765.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t3765.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3765.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta3766
      };
      cljs.core.t3765.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t3765(this.meta, this.f, b)
      }
    }
    return new cljs.core.t3765(b, a, null)
  }(), b)
};
...
var simplestratserver = {httpserver:{}};
simplestratserver.httpserver.connect = cljs.nodejs.require.call(null, "connect");
simplestratserver.httpserver.http = cljs.nodejs.require.call(null, "http");
simplestratserver.httpserver.listenport = 5E3;
simplestratserver.httpserver.start = function() {
  var a = function() {
    simplestratserver.httpserver.connect.call(null).use(simplestratserver.httpserver.connect["static"].call(null, "resources/public")).listen(simplestratserver.httpserver.listenport);
    return cljs.core.println.call(null, "Static server started on port", simplestratserver.httpserver.listenport)
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
cljs.core._STAR_main_cli_fn_STAR_ = simplestratserver.httpserver.start;
cljs.nodejscli = {};
