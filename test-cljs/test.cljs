...
(def character1 (gw/create-character
                 {:charactername "test character"
                  ...
                  :actions [
                            (action/createmoveaction "walk" 100 27 1 "Walk one space" :simplemove)
                            (action/createmajoraction "punch" 101 22 1 1 "Punch an adjacent enemy for 1 damage" :singletarget)
                            ]
                  }))
...
(def character2 (gw/create-character
                 {:charactername "second character"
                  ...
                  :actions [
                            (action/createmoveaction "run" 200 2 2 "Run up to two spaces" :simplemove)
                            (action/createmajoraction "shoot" 201 2 5 2 "Shoot an enemy up to two spaces away" :singletarget)
                            ]
                  }))
